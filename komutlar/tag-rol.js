...
.setTitle('Bir hata oldu!').setDescription(`• \`s*tag-role\` **kullanmak için,** \`Yönetici\` **yetkisine sahip olman gerekiyor.**`));
  ...
  db.set(`tag.role.${message.guild.id}`, mentionRole.id);
